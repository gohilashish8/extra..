...
const AddNewData = () => {
  return (
    ...
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-4">
   ...
   <div class="-mx-3 md:flex mb-2">
     ...
     <div class="md:w-1/2 px-3">
       ...
       <div class="relative">
         <select class="block appearance-none w-full bg-grey-lighter border border-grey-lighter text-grey-darker py-3 px-4 pr-8 rounded group:" id="grid-state">
           <option>New Mexico</option>
           <option>Missouri</option>
           <option>Texas</option>
         </select>
         <div class="pointer-events-none absolute pin-y pin-r flex items-center px-2 text-grey-darker right-0 top-[50%] translate-y-[-50%] group-focus:rotate-180 ">
